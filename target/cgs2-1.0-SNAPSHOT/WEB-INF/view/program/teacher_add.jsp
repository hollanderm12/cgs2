...
<body class="w3-khaki">
    ...
    <form:form action="./teacher_add" method="POST" commandName="command" cssClass="w3-container"> 
        <jsp:include page="/resources/form_display/teacher_form.jsp"/>
        <div class="w3-row-padding w3-margin-bottom">       
            <div class="w3-col">
                <input type="submit" class="w3-button w3-large w3-amber w3-border w3-border-black" value="Add Teacher">
            </div>
        </div>
    </form:form>
</body>
