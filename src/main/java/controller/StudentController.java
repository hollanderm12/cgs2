...
{   
    ...
    public String postAddStudent(@ModelAttribute("command") @Valid Student s, BindingResult br, Map model) {
        if(br.hasErrors())
            return "student/student_add";
    ...
    public String postStudentEdit(@PathVariable("id") String id, @ModelAttribute("command") @Valid Student s, BindingResult br, Map model) {
        if(br.hasErrors())
    ...
    public String postDeleteStudent(@PathVariable("id") Integer id) {
